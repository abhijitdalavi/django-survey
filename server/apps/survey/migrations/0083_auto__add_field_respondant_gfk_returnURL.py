...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.gfk_returnURL'
        db.add_column(u'survey_respondant', 'gfk_returnURL',
                      self.gf('django.db.models.fields.URLField')(default=None, max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.gfk_returnURL'
        db.delete_column(u'survey_respondant', 'gfk_returnURL')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'gfk_returnURL': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '500', 'null': 'True', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'94850aeb-b4c9-4db2-a4d3-2732a9edc24a'", 'max_length': '36', 'primary_key': 'True'}),
